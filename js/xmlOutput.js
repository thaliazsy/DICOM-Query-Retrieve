...
function formInputsToXML(type, URL, uid, svgBase64, vw, vh, wc, ww, pixelData, dcmFile, annotationType) {
	...
	// output+= '<code value="' + type + '"/></coding></code>'; 
	// output+= '<component><code><coding><system value="https://www.dicom.org.tw/SVG"/><code value="SVG_Annotation"/></coding></code><valueString value="' + svgBase64 + '"></valueString></component>'; 
	// output+= '<component><code><coding><system value="https://www.dicom.org.tw/Columns"/><code value="Columns"/></coding></code><valueString value="' + vw + '"></valueString></component>';
	// output+= '<component><code><coding><system value="https://www.dicom.org.tw/Rows"/><code value="Rows"/></coding></code><valueString value="' + vh + '"></valueString></component>';
	// output+= '<component><code><coding><system value="https://www.dicom.org.tw/WindowLevel"/><code value="WindowCenter"/></coding></code><valueString value="' + wc + '"></valueString></component>';
	// output+= '<component><code><coding><system value="https://www.dicom.org.tw/WindowLevel"/><code value="WindowWidth"/></coding></code><valueString value="' + ww + '"></valueString></component>';
	// output+= '<component><code><coding><system value="https://www.dicom.org.tw/OffsetOfPixelData"/><code value="OffsetOfPixelData"/></coding></code><valueString value="' + pixelData + '"></valueString></component>';
	// output+= '<component><code><coding><system value="https://www.dicom.org.tw/DCM_File"/><code value="DCM_File"/></coding></code><valueString value="' + dcmFile + '"/></component></Observation>'; 
	// alert(output);
